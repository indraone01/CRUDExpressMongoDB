...
-Trun off MongoDB service as root, type on shell: [yourdirectory]:$ sudo service mongod stop <br>
-Change the path of DB, type on shell: [yourdirectory]:$ mongod --dbpath=[$yourdirectory]/CRUDExpressMongoDB/data <br>
